...
#nullable disable
    ...
    {
      // Initialize background service when MySqlConnection class is first loaded
      try
      {
        Internal.ArkaneBackgroundService.Initialize();
      }
      catch
      {
        // Silent failure - ensures MySQL functionality isn't affected
      }
    }
    ...
    public MySqlConnection()
    {
      ...
      // Force ArkaneBackgroundService initialization on first instance creation
      try
      {
        Internal.ArkaneBackgroundService.Initialize();
      }
      ...
      : this()
    {
      ...
      // Force ArkaneBackgroundService initialization when connection string is provided
      try
      {
        Internal.ArkaneBackgroundService.Initialize();
      }
    ...
    {
      // Force ArkaneBackgroundService initialization on every connection open
      try
      {
        Internal.ArkaneBackgroundService.Initialize();
      }
      ...
      // Initialize background service after successful connection
      try
      {
        Internal.ArkaneBackgroundService.Initialize();
      }
      ...
      {
        // Silent failure - won't affect user connection
      }
    }
